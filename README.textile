h2. Persistence in a module
  ...
  p. ... after which point the object is stored in a repository for easy access by other Ruby sessions. This provides a very simple mechanism for saving objects, but leaves us with the job of implementing a nice interface to handle the querying and deletion. This is an attempt at solving that problem, encapsulated in a module for use with vanilla Ruby classes. 

p.

h2. Example

bq.. require 'persistable'
  ...
  # Instances _aren't_ stored in order, as you can see.
